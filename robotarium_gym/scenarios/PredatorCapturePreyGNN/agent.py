...
class Agent:
    ...
    def __init__(self, index, sensing_radius, capture_radius, action_id_to_word, action_word_to_id, args):
        self.index = index
    ...
    def get_observation( self, state_space, agents):
        ...
        if self.args.capability_aware:
            ...
            if self.sensing_radius > 1:
                ...
                observation = np.array([*state_space['poses'][:, self.index ][:2], *prey_loc, 0, 1])
        else:
